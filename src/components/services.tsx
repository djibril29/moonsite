      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-3">
          {services.map((s) => (
            <article
              key={s.title}
              className="group flex flex-col items-center rounded-3xl border border-black/5 bg-surface px-5 py-9 text-center shadow-sm shadow-navy/5 transition-all duration-300 hover:-translate-y-1.5 hover:border-orange/20 hover:shadow-xl hover:shadow-navy/10 sm:px-8 sm:py-12"
            >
